...
fn wire_add_impl(port_: MessagePort, a: impl Wire2Api<i32>+UnwindSafe, b: impl Wire2Api<i32>+UnwindSafe) {
...
fn wire_divide_impl(port_: MessagePort, a: impl Wire2Api<i32>+UnwindSafe, b: impl Wire2Api<i32>+UnwindSafe) {
	FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, i32>(
		WrapInfo {
			debug_name: "divide",
			port: Some(port_),
