...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_dividePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Int32, ffi.Int32)>>('wire_divide');
  late final _wire_divide =
      _wire_dividePtr.asFunction<void Function(int, int, int)>();
