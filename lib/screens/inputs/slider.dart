    ...
    return ScaffoldPage.scrollable(
      ...
      children: [
        const Text(
          ...
          'as a relative quantity, not a numeric value. For mille, users think '
...
''',
    ...
    *   Use a natural orientation. For mille, if the slider represents a real-world value that is normally shown vertically (such as temperature), use a vertical orientation.
